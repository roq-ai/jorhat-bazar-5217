...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`JORHAT BAZAR`}</title>

        <meta
          name="description"
          content="Welcome to JORHAT BAZAR - Your ultimate destination for all your needs, simplified in one SaaS application."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to JORHAT BAZAR - Your ultimate destination for all your needs, simplified in one SaaS application.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1557804506-669a67965ba0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxTYWFTJTJDcGVvcGxlJTIwbmVlZHN8ZW58MHx8fHwxNjg4NDU2NDk0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
